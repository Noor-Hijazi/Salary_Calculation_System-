...
namespace SalaryCalculationSystem
{
    ...
    {
        public decimal TraningAllowance { get; set; }
        public decimal StroyPontCompleted { get; set; }


        private decimal Bouns ()
        {
            return StroyPontCompleted >= 8 ? 40 : 0;
        }
        protected override decimal CalulateGrossPay()
        {
            return base.CalulateGrossPay() + TraningAllowance + Bouns();
        }
        ...
        public override string ShowSalarySlip()
        {
            ...
            return $"Employee: #{Id} ({FullName}). \n" +
                    ...
                    $"Bouns: {bouns.ToString("C")}\n" +
                    $"Traning Allowance: {TraningAllowance.ToString("C")}\n" +
